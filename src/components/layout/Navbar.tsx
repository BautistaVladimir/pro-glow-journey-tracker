...
import { Menu, X, User, Home, Activity, Apple, Moon, Target, LogOut, Shield } from 'lucide-react';
          ...
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            {user ? (
              <>
                ...
                <button
                  className="w-full text-left block px-3 py-2 rounded-md text-base font-medium flex items-center text-foreground hover:bg-muted hover:text-proglo-purple"
                  onClick={() => {
                    logout();
                    setIsMenuOpen(false);
                  }}
